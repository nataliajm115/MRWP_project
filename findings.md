...
- **Random failure, AS:** the gap shrinks monotonically across ER → BA → CM, and Δf_c against CM is within one standard deviation of zero. AS is well-described by all three nulls.
